            ...
            case "SHIRO":
                ...
                try {
                    ...
                    if (inipath != null){
                        ...
                        if (inipath.length() == 0){
                            throw new ServiceManagerException(global, SysErrorCode.INTERNAL_ILLEGALARGUMENT, "No ini path supplied for Shiro configuration, please set server.security.shiro.inipath");
                    ...
                    throw new ServiceManagerException(glob, SysErrorCode.RESOURCE_CONFIGURATION, "Could not initialize Shiro framework:"+e);
                }
                break;
            default:
