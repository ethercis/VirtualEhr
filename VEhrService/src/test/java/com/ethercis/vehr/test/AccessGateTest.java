...
public class AccessGateTest extends TestCase {
    ...
    public void testAccessGateService2() throws ServiceManagerException {
        ...
        SessionClientProperties retprops = headerProperties(accessGateService.queryHandler(MethodName.GET, hdrprops, "vehr", MethodName.CONNECT, props));
       ...
       accessGateService.queryHandler(MethodName.GET, hdrprops, "vehr", MethodName.DISCONNECT, parms);
    }
    ...
    public void testAccessGateService() throws ServiceManagerException {
        ...
        String sessionName = retprops.getClientProperty(I_SessionManager.SESSION_NAME, (String) null);
        assertEquals("/node/testnode/client/joe/-1", sessionName);
...
//    @Test
    public void _testCheckPermission() throws ServiceManagerException, IOException {
        SessionClientProperties props = new SessionClientProperties(global);
     ...
     */
//    @Test
    public void _testMultiCheckPermission() throws ServiceManagerException, IOException {
        SessionClientProperties props = new SessionClientProperties(global);
     ...
     */
//    @Test
    public void _testMultiCheckPermission2() throws ServiceManagerException, IOException {
        SessionClientProperties props = new SessionClientProperties(global);
     ...
     */
//    @Test
    public void _testMultiCheckPermission3() throws ServiceManagerException, IOException {
        SessionClientProperties props = new SessionClientProperties(global);
...
//		hp.put("xpath", new String[]{"/authenticate[@id='JOE']"});
    ...
    private SessionClientProperties headerProperties(Object responseHolder) {
        if (responseHolder instanceof Map)
            return (SessionClientProperties) ((Map)responseHolder).get("headers");
        else
            return null;
    }
