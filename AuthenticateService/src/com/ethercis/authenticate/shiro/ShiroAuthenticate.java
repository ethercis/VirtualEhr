...
public class ShiroAuthenticate implements I_Authenticate {
	...
	public ShiroAuthenticate(RunTimeSingleton glob, String id) throws ServiceManagerException {
        ...
        try {
           ...
           throw new ServiceManagerException(glob, SysErrorCode.RESOURCE_CONFIGURATION, "Shiro Security Manager is not configured properly:"+usme);
        }
	...
	public boolean checkPrivateCredentials(String logonId, String passwd) throws ServiceManagerException {
        ...
        try {
            ...
            throw new ServiceManagerException(global, SysErrorCode.USER_CONNECT, "Unknown account:"+logonId);
        } catch (IncorrectCredentialsException ice){
            throw new ServiceManagerException(global, SysErrorCode.USER_CONNECT, "Invalid credential:"+logonId);
        } catch (LockedAccountException lae){
            throw new ServiceManagerException(global, SysErrorCode.USER_CONNECT, "Account is locked:"+logonId);
        } catch (ExcessiveAttemptsException eae){
            throw new ServiceManagerException(global, SysErrorCode.USER_CONNECT, "Too many login attempts:"+logonId);
        } catch (AuthenticationException ae){
            throw new ServiceManagerException(global, SysErrorCode.INTERNAL_CONNECTIONFAILURE, "Internal connection error:"+logonId);
        }
