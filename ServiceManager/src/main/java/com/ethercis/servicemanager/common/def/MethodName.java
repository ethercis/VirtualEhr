...
public final class MethodName implements java.io.Serializable, Comparable<Object>
{
	...
	//used to force a return type from a service via the RunTimeSingleton
	public static final String RETURN_TYPE_PROPERTY = "return.type.property";
	...
	public static final int RETURN_NO_CONTENT = 10;
	public static final int RETURN_UNDEFINED = -1;

    //some string constants for JSON response compliant with openEHR API standard
