...
public class StringPairTokenizer {
    ...
    *
    * If a value is missing then a null object will be put into the map logonservice value.
   ...
   /**
    * Parsing for example >"classpath=xerces.jar:soap.jar,all",MAXSIZE=100,a=10<.
    * <p>
    ...
    */
         ...
         *
         * @param nextLine a string array with each comma-separated element logonservice a separate
         *         entry.
         *
         * @throws IOException
    ...
    * If a value is missing then a null object logonservice value.
