...
public class Timeout extends Thread implements I_TimeoutManager {
   ...
   public final TimeStamp refreshTimeoutListener(TimeStamp key, long delay)
      ...
      if (key == null) {
         Thread.dumpStack();
         throw new ServiceManagerException(RunTimeSingleton.instance(),
               SysErrorCode.INTERNAL_NULLPOINTER, ME + "addTimeoutListener",
      ...
      if (obj == null) {
         String pos = RunTimeSingleton.getStackTraceAsString(null);
         throw new ServiceManagerException(RunTimeSingleton.instance(),
               SysErrorCode.RESOURCE_UNAVAILABLE, ME, "The timeout handle '" + key
   ...
   public final TimeStamp addOrRefreshTimeoutListener(I_Timeout listener,
      ...
      if (key == null) {
         ...
         try {
            ...
            if (SysErrorCode.RESOURCE_UNAVAILABLE == e.getErrorCode()) {
               return addTimeoutListener(listener, delay, userData);
            }
            throw e;
         }
