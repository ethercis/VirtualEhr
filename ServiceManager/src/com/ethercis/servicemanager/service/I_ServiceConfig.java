...
public interface I_ServiceConfig {
	   /**
	   ...
	   /**
	    * Gets the prefix for the implementing service. 
	    * Suppose you have two services ('serviceA1' and 'serviceB2') both containing an 
	    ...
	    * For example 
	    * 'service/${serviceType}/' which would be 'service/serviceA1/'
	    * @return
	    */
