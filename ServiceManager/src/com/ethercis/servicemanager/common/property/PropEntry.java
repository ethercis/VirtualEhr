...
public abstract class PropEntry implements java.io.Serializable, Cloneable
{
   ...
   public static final int CREATED_BY_SETTER = 4;
    private static final long serialVersionUID = -2250020194991892438L;
   ...
   public final String setFromEnv(RunTimeSingleton glob, ContextNode contextNode, String propName) {
    ...
    */
   public final String setFromEnv(RunTimeSingleton glob,
    ...
    * @return internal state of the property logonservice a XML ASCII string
    */
